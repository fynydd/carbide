...
namespace Fynydd.Carbide.Constants
{
    ...
    {
        /// <summary>
        /// Character sequences that need to be escaped for Lucene searches.
        /// </summary>
        public static readonly string[] LuceneSpecialCharacters = new string[]
        {
            @"\",
            @"+",
            @"-",
...
";
    ...
    /// <summary>
    /// Constants for use with binary data
    /// </summary>
    public static class Bytes
    {
        /// <summary>
        /// Base16 character table for hexadecimal conversions.
        /// </summary>
        public static readonly string[] Base16CharTable = new[]
        {
