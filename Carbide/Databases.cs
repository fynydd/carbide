...
{
    /// <summary><![CDATA[
    /// The Databases class contains methods and properties for
    ...
    public static class Databases
    {
        ...
        /// <example>
        /// <code><![CDATA[
        /// string result = Databases.Lookup("SELECT TOP 5 * FROM ContentTable", "SqlServer01", 30);
        /// string result2 = Databases.Lookup("exec spu_ProcedureName", "SqlServer02", 30);
        /// ]]></code>
        /// </example>
        ...
        /// <example>
        /// <code><![CDATA[
        /// bool result = Databases.Exec("spu_ProcedureName @param1='test';", "SqlServer01", 60);
        /// ]]></code>
        /// </example>
        ...
        /// string result = Databases.PowerExec("spu_Function_Name", fields, values, true, "SqlServer01");
        /// ]]></code>
        /// </example>
        ...
        /// <example>
        /// <code><![CDATA[
        /// DataTable dt = Databases.ReadTable("SELECT TOP 5 FROM tablename;", "SqlServer01");
        /// ]]></code>
        /// </example>
        /// <param name="statement">SQL statement to execute</param>
        /// <param name="connectionStringName">Name of a connection string in the Web.config file</param>
        ...
        public static bool ExportCSV(this UmbracoContext umbCtx, string select, string connectionStringName, bool includeHeaders, bool alwaysUseQuotes, string filePath)
        {
            bool result = false;
            ...
            umbCtx.WriteFile(filePath, CSV.ToString());

            if (umbCtx.FileExists(filePath))
            {
                result = true;
            }
