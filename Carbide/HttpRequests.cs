...
namespace Fynydd.Carbide
{
    ...
    public static class HttpRequests
    {
        ...
        public static string GetSeoHost(this UmbracoContext umbCtx)
        {
            var domain = umbCtx.HttpContext.Request.Url.Host.ToLower();

            if (umbCtx.HttpContext.Request.Url.Port != 80 && umbCtx.HttpContext.Request.Url.Port != 443)
            {
                domain += ":" + umbCtx.HttpContext.Request.Url.Port;
            }
        ...
        public static string GetHost(this UmbracoContext umbCtx)
        {
            return umbCtx.HttpContext.Request.Url.Host;
        }
        ...
        public static string GetHostWithPort(this UmbracoContext umbCtx)
        {
            return umbCtx.HttpContext.Request.Url.Host + ":" + umbCtx.HttpContext.Request.Url.Port;
        }
        ...
        public static string GetHostRoot(this UmbracoContext umbCtx)
        {
            String fqdn = umbCtx.GetHost();
            String dn = fqdn;
        ...
        /// <example>
        /// <code><![CDATA[
        /// string result = HttpRequests.GetWebPage("http://www.site.com");
        /// ]]></code>
        /// </example>
        ...
        /// <example>
        /// <code><![CDATA[
        /// string result = HttpRequests.GetWebPage("http://www.site.com", myCookies);
        /// ]]></code>
        /// </example>
        /// <param name="url">Fully qualified URL to the remote page</param>
        ...
        /// <example>
        /// <code><![CDATA[
        /// string result = HttpRequests.GetWebPage("http://www.site.com", HttpRequests.GetWebPageMethod.Get, postData);
        /// ]]></code>
        /// </example>
        /// <param name="url">Fully qualified URL to the remote page</param>
        ...
        /// <example>
        /// <code><![CDATA[
        /// string result = HttpRequests.GetWebPage("http://www.site.com", "jsmith", "password");
        /// ]]></code>
        /// </example>
        /// <param name="url">Fully qualified URL to the remote page</param>
        ...
        /// <example>
        /// <code><![CDATA[
        /// string result = HttpRequests.GetWebPage("http://www.site.com", HttpRequests.GetWebPageMethod.Get, cookies, postData, "jsmith", "password");
        /// ]]></code>
        /// </example>
        /// <param name="url">Fully qualified URL to the remote page</param>
        /// <param name="method">GetWebPageMethod enum value</param>
        ...
        public static string GetWebPage(string url, GetWebPageMethod method, CookieContainer cookies, string postData, string userName, string password, int timeoutMilliseconds)
        {
            ...
            try
            {
                ...
                if (method == GetWebPageMethod.Post && postData.HasValue())
                {
        ...
        public static long WriteBinaryFile(this UmbracoContext umbCtx, string url, string filePath)
        {
            long bytesWritten = 0;
            ...
            try
            {
                ...
                FileStream fileToWrite = new FileStream(umbCtx.HttpContext.Server.MapPath(filePath), FileMode.Create, FileAccess.Write);
        ...
        public static double GetInternetExplorerVersion(this UmbracoContext umbCtx)
        {
            double ver;

            ver = umbCtx.GetBrowserVersion("IE");

            if (ver == -1)
            {
                ver = umbCtx.GetBrowserVersion("InternetExplorer");
            }
        ...
        public static double GetFirefoxVersion(this UmbracoContext umbCtx)
        {
            return umbCtx.GetBrowserVersion("Firefox");
        }
        ...
        public static double GetSafariVersion(this UmbracoContext umbCtx)
        {
            return umbCtx.GetBrowserVersion("Safari");
        }
        ...
        /// <param name="umbCtx">Umbraco context object to use</param>
        /// <returns>Version of Safari, or -1 if not Safari</returns>
        public static double GetChromeVersion(this UmbracoContext umbCtx)
        {
            return umbCtx.GetBrowserVersion("Chrome");
        }
        ...
        public static double GetBrowserVersion(this UmbracoContext umbCtx, string browserName)
        {
            // Returns the version of Mozilla Firefox or a -1
            // (indicating the use of another browser).
            double rv = -1;

            System.Web.HttpBrowserCapabilitiesBase browser = umbCtx.HttpContext.Request.Browser;
        ...
        public static string GetBrowserName(this UmbracoContext umbCtx)
        {
            System.Web.HttpBrowserCapabilitiesBase browser = umbCtx.HttpContext.Request.Browser;
        ...
        public static string GetBrowserMajorVersion(this UmbracoContext umbCtx)
        {
            System.Web.HttpBrowserCapabilitiesBase browser = umbCtx.HttpContext.Request.Browser;
        ...
        public static string GetBrowserMinorVersion(this UmbracoContext umbCtx)
        {
            System.Web.HttpBrowserCapabilitiesBase browser = umbCtx.HttpContext.Request.Browser;
        ...
        public static string GetIPAddress(this UmbracoContext umbCtx)
        {
            if (umbCtx.HttpContext.Request.UserHostAddress == "::1")
            {
                return "127.0.0.1";
            }
            ...
            {
                return umbCtx.HttpContext.Request.UserHostAddress;
            }
        }
        ...
        public static string GetOSType(this UmbracoContext umbCtx)
        {
            string userAgent = "";

            if (umbCtx.HttpContext.Request.UserAgent != null)
            {
                userAgent = umbCtx.HttpContext.Request.UserAgent;
            }
        ...
        public static string GetUrlParams(this UmbracoContext umbCtx, bool includePrefix)
        {
            string urlParams = "";

            if (umbCtx.HttpContext.Request.ServerVariables["QUERY_STRING"].ToString().Length > 0)
            {
                urlParams = umbCtx.HttpContext.Request.ServerVariables["QUERY_STRING"].ToString();
            }

            if (includePrefix)
            {
                if (urlParams.HasValue())
                {
                    urlParams = "?" + urlParams;
                }
            }
        ...
        public static string GetUrlParams(this UmbracoContext umbCtx)
        {
            return umbCtx.GetUrlParams(false);
        }
        ...
        /// <param name="urlParam">Name of the URL parameter to remove</param>
        /// <returns>Altered URL parameter string without the leading "?"</returns>
        public static string DeleteUrlParameter(this UmbracoContext umbCtx, string urlParam)
        {
            return DeleteUrlParameter(umbCtx.GetUrlParams(), urlParam);
        }
        ...
        /// <param name="value">Value of the URL parameter to add or edit</param>
        /// <returns>Altered URL parameter string without the leading "?"</returns>
        public static string SetUrlParameterValue(this UmbracoContext umbCtx, string urlParam, string value)
        {
