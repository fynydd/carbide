...
namespace Fynydd.Carbide
{
    ...
    public static class Images
    {
        ...
        /// string finalPath = Images.ResizeImage("/portfolio/picture01.jpg", 80, 320, 0, "/portfolio/temp/upload.jpg", cropArea);
        /// ]]></code>
        /// </example>
        ...
        public static string ResizeImage(this UmbracoContext umbCtx, string imageSavePath, int quality, int maxWidth, int maxHeight, string path, Rectangle cropArea)
        {
            ...
            if (imageSavePath.Length > 2)
            {
                ...
                {
                    imageSavePath = umbCtx.MapPath(imageSavePath);
                }
            }
            ...
            if (newPath.Length > 2)
            {
                ...
                {
                    newPath = umbCtx.MapPath(newPath);
                }
            }
            ...
            try
            {
                ...
                {
                    image = umbCtx.CropImage(path, cropArea.Width, cropArea.Height, cropArea.Left, cropArea.Top);
                }
        ...
        /// <example>
        /// <code><![CDATA[
        /// string finalPath = Images.ResizeImage("/portfolio/picture01.jpg", 80, 320, 0, "/portfolio/temp/upload.jpg");
        /// ]]></code>
        /// </example>
        /// <param name="umbCtx">Umbraco context object to use</param>
        /// <param name="imageSavePath">Web-style path with filename for the final resized image</param>
        ...
        /// <param name="path">Web-style path to the source image file</param>
        /// <returns>The web path to the saved file on success, empty string on failure</returns>
        public static string ResizeImage(this UmbracoContext umbCtx, string imageSavePath, int quality, int maxWidth, int maxHeight, string path)
        {
            Rectangle cropArea = new Rectangle(0, 0, 0, 0);
            return umbCtx.ResizeImage(imageSavePath, quality, maxWidth, maxHeight, path, cropArea);
        }
        ...
        /// <example>
        /// <code><![CDATA[
        /// Image croppedImage = Images.CropImage("/portfolio/picture01jpg", 320, 0, 0, 0);
        /// ]]></code>
        /// </example>
        /// <param name="umbCtx">Umbraco context object to use</param>
        /// <param name="path">Web-style path to the source image file</param>
        ...
        static System.Drawing.Image CropImage(this UmbracoContext umbCtx, string path, int Width, int Height, int Left, int Top)
        {
            string newPath = path;
