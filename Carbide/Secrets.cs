...
{
    /// <summary><![CDATA[
    /// The Secrets class contains methods and properties for
    ...
    public static class Secrets
    {
        ...
        /// <example>
        /// <code><![CDATA[
        /// Byte[] baseKey = Secrets.CreateBaseKey("151, 4, 109, 42, 135, 99, 67, 82, 242, 233, 16, 200, 9, 83, 196, 178, 56, 74, 90, 36, 206, 129, 81, 229, 67, 82, 242, 233, 16, 200, 9, 83");
        /// ]]></code>
        /// </example>
        ...
        /// <example>
        /// <code><![CDATA[
        /// Byte[] baseIV = Secrets.CreateInitVector("180, 54, 206, 210, 10, 101, 6, 87, 13, 3, 241, 189, 176, 175, 109, 217");
        /// ]]></code>
        /// </example>
        ...
        /// <example>
        /// <code><![CDATA[
        /// string baseKey = Secrets.GenerateKey(32);
        /// ]]></code>
        /// </example>
        ...
        /// string encryptedVar = Secrets.Encrypt<string>(dataToEncrypt, key, ivec);
        /// ]]></code>
        /// </example>
        ...
        /// <example>
        /// <code><![CDATA[
        /// string encryptedVar = Secrets.Encrypt<string>(myData, "151, 4, 109, 42, 135, 99, 67, 82, 242, 233, 16, 200, 9, 83, 196, 178, 56, 74, 90, 36, 206, 129, 81, 229, 67, 82, 242, 233, 16, 200, 9, 83", "180, 54, 206, 210, 10, 101, 6, 87, 13, 3, 241, 189, 176, 175, 109, 217" );
        /// ]]></code>
        /// </example>
        /// <param name="data">Data to encrypt</param>
        ...
        /// <example>
        /// <code><![CDATA[
        /// string encryptedVar = Secrets.Encrypt<string>(myData);
        /// ]]></code>
        /// </example>
        /// <param name="data">Data to encrypt</param>
        /// <returns>A BASE64+ encrypted string</returns>
        ...
        /// <example>
        /// <code><![CDATA[
        /// string decryptedVar = Secrets.Decrypt<string>(encryptedVar, "151, 4, 109, 42, 135, 99, 67, 82, 242, 233, 16, 200, 9, 83, 196, 178, 56, 74, 90, 36, 206, 129, 81, 229, 67, 82, 242, 233, 16, 200, 9, 83", "180, 54, 206, 210, 10, 101, 6, 87, 13, 3, 241, 189, 176, 175, 109, 217" );
        /// ]]></code>
        /// </example>
        ...
        /// <example>
        /// <code><![CDATA[
        /// string decryptedVar = Secrets.Decrypt<string>(encryptedVar);
        /// ]]></code>
        /// </example>
        /// <param name="data">String to decrypt</param>
        /// <returns>A decrypted variable</returns>
        ...
        /// Byte[] ivec = { 180, 54, 206, 210, 10, 101, 6, 87, 13, 3, 241, 189, 176, 175, 109, 217 };
        /// Byte[] key = { 151, 4, 109, 42, 135, 99, 67, 82, 242, 233, 16, 200, 9, 83, 196, 178, 56, 74, 90, 36, 206, 129, 81, 229, 67, 82, 242, 233, 16, 200, 9, 83 };
        /// String decryptedVar = Secrets.Decrypt<string>(encryptedVar, bytekey, ivec);
        /// ]]></code>
        /// </example>
        /// <param name="data">String to decrypt</param>
        ...
        /// <example>
        /// <code><![CDATA[
        /// string encodedVar = Secrets.MD5String(stringVar);
        /// ]]></code>
        /// </example>
        ...
        /// <example>
        /// <code><![CDATA[
        /// if (Secrets.MD5VerifyString(stringVar, hash))...
        /// ]]></code>
        /// </example>
        ...
        public static bool MD5VerifyString(this string input, string hash)
        {
            ...
            if (input.HasValue() && hash.HasValue())
            {
                // Hash the input.
        ...
        /// <example>
        /// <code><![CDATA[
        /// string encodedVar = Secrets.Base64StringEncode(stringVar);
        /// ]]></code>
        /// </example>
        ...
        /// <example>
        /// <code><![CDATA[
        /// string encodedVar = Secrets.Base64Encode(bytes);
        /// ]]></code>
        /// </example>
        ...
        /// <example>
        /// <code><![CDATA[
        /// string decodedVar = Secrets.Base64DecodeToString(stringVar);
        /// ]]></code>
        /// </example>
        ...
        /// <example>
        /// <code><![CDATA[
        /// byte[] decodedVar = Secrets.Base64DecodeToBytes(stringVar);
        /// ]]></code>
        /// </example>
        /// <param name="input">A Base64-encoded string</param>
        ...
        /// <example>
        /// <code><![CDATA[
        /// string encodedVar = Secrets.Base64UrlEncode(bytes);
        /// ]]></code>
        /// </example>
        /// <param name="input">A byte array to encode</param>
        ...
        /// <example>
        /// <code><![CDATA[
        /// string encodedVar = Secrets.Base64UrlEncode(stringVar);
        /// ]]></code>
        /// </example>
        /// <param name="input">A string to encode</param>
        /// <returns>A Base64Url-encoded string</returns>
        ...
        /// <example>
        /// <code><![CDATA[
        /// byte[] decodedVar = Secrets.Base64UrlDecodeToBytes(stringVar);
        /// ]]></code>
        /// </example>
        ...
        /// <example>
        /// <code><![CDATA[
        /// string decodedVar = Secrets.Base64UrlDecodeToString(stringVar);
        /// ]]></code>
        /// </example>
        /// <param name="input">A Base64Url-encoded string</param>
        /// <returns>A decoded string</returns>
        ...
        /// <code><![CDATA[
        /// string base64Secret = Secrets.Base64StringEncode("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789!@");
        /// string payload = "{ \"sub\": \"test\", \"name\": \"Michael Argentini\" }";
        /// string jwt = Secrets.GenerateJWT(payload, base64Secret, "HS256");
        /// ]]></code>
        /// </example>
        ...
        /// string payload = "{ \"sub\": \"test\", \"name\": \"Michael Argentini\" }";
        /// string jwt = Secrets.GenerateJWT(payload, base64Secret, "HS256");
        /// if (Secrets.VerifyJWT(jwt, base64Secret))
        /// {
