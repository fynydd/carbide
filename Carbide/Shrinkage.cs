...
{
    /// <summary><![CDATA[
    /// The Shrinkage class contains methods for compressing and decompressing data.
    /// ]]></summary>
    public static class Shrinkage
    {
        ...
        /// <example>
        /// <code><![CDATA[
        /// string compressedVar = Shrinkage.CompressString(stringVar);
        /// ]]></code>
        /// </example>
        ...
        /// <example>
        /// <code><![CDATA[
        /// string decompressedVar = Shrinkage.DecompressString(compressedVar);
        /// ]]></code>
        /// </example>
        ...
        /// <example>
        /// <code><![CDATA[
        /// byte[] compressedVar = Shrinkage.Compress(byteBuff);
        /// ]]></code>
        /// </example>
        ...
        /// <example>
        /// <code><![CDATA[
        /// byte[] decompressedVar = Shrinkage.Decompress(byteBuff);
        /// ]]></code>
        /// </example>
        /// <param name="gzipBuffer">Byte array to decompress</param>
