(function () {    
    ...
    $.validator.addMethod('minimumfilesize', function (value, element, minSize) { 
        ...
        if (element.files.length > 0) {
            ...
            return convertBytesToMegabytes(file.size) >= parseFloat(minSize); 
    ...
    $.validator.addMethod('maximumfilesize', function (value, element, maxSize) { 
        ...
        if (element.files.length > 0) {
            ...
            return convertBytesToMegabytes(file.size) <= parseFloat(maxSize); 
    ...
    }, "This is not a valid individual name"); 
