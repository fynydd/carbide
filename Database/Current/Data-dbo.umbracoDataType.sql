...
-- SQRIBE/INSERT;ef17d2
INSERT INTO [dbo].[umbracoDataType] ([nodeId],[propertyEditorAlias],[dbType],[config]) VALUES (-51,N'Umbraco.Integer',N'Integer',N'{"min":1,"step":1}');
-- SQRIBE/INSERT;ef17d2
...
-- SQRIBE/INSERT;ef17d2
INSERT INTO [dbo].[umbracoDataType] ([nodeId],[propertyEditorAlias],[dbType],[config]) VALUES (1062,N'Umbraco.TinyMCE',N'Ntext',N'{"editor":{"toolbar":["ace","styleselect","bold","italic","alignleft","aligncenter","alignright","bullist","numlist","link","umbmediapicker","umbmacro","umbembeddialog","hr","subscript","superscript","charmap"],"stylesheets":[],"maxImageSize":500,"mode":"classic"},"hideLabel":false,"ignoreUserStartNodes":false}');
-- SQRIBE/INSERT;ef17d2
...
-- SQRIBE/INSERT;ef17d2
INSERT INTO [dbo].[umbracoDataType] ([nodeId],[propertyEditorAlias],[dbType],[config]) VALUES (1100,N'Carbide.StaticText',N'Ntext',N'{"defaultValue":"<hr />\n<h4>Optional Button</strong></h4>\n<p>Display a button below the rich content.</p>","fullWidth":"1"}');
-- SQRIBE/INSERT;ef17d2
...
-- SQRIBE/INSERT;ef17d2
INSERT INTO [dbo].[umbracoDataType] ([nodeId],[propertyEditorAlias],[dbType],[config]) VALUES (1193,N'Umbraco.RadioButtonList',N'Nvarchar',N'{"items":[{"id":2,"value":"Children"},{"id":3,"value":"Siblings"}]}');
-- SQRIBE/INSERT;ef17d2
INSERT INTO [dbo].[umbracoDataType] ([nodeId],[propertyEditorAlias],[dbType],[config]) VALUES (1195,N'Carbide.StaticText',N'Ntext',N'{"defaultValue":"<hr />\n<h4>Sidebar Navigation</h4>","fullWidth":"1"}');
-- SQRIBE/INSERT;ef17d2
...
-- SQRIBE/INSERT;ef17d2
INSERT INTO [dbo].[umbracoDataType] ([nodeId],[propertyEditorAlias],[dbType],[config]) VALUES (1224,N'Umbraco.NestedContent',N'Ntext',N'{"contentTypes":[{"ncAlias":"multiColumnContentSubunitColumn","ncTabAlias":"Content","nameTemplate":"{{unitName}}"}],"minItems":1,"confirmDeletes":true,"showIcons":true,"hideLabel":true}');
-- SQRIBE/INSERT;ef17d2
...
-- SQRIBE/INSERT;ef17d2
INSERT INTO [dbo].[umbracoDataType] ([nodeId],[propertyEditorAlias],[dbType],[config]) VALUES (1281,N'Umbraco.MultiNodeTreePicker',N'Ntext',N'{"startNode":{"type":"content","query":"$site/objectCollection","id":null},"filter":"sidebarNavigation","minNumber":0,"maxNumber":1,"showOpenButton":true,"ignoreUserStartNodes":false}');
-- SQRIBE/INSERT;ef17d2
INSERT INTO [dbo].[umbracoDataType] ([nodeId],[propertyEditorAlias],[dbType],[config]) VALUES (1284,N'Carbide.StaticText',N'Ntext',N'{"defaultValue":"<hr />\n<h4>Content</h4>","fullWidth":"1"}');
-- SQRIBE/INSERT;ef17d2
